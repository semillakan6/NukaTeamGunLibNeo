...
public class Config
{
    ...
    public static class Particle
    {
        ...
        public Particle(ModConfigSpec.Builder builder)
        {
            builder.comment("Properties relating to particles").push("particle");
            {
                ...
                this.enableBlood = builder.comment("If true, blood will spawn from entities that are hit from a projectile").define("enableBlood", true);
                this.enableDeathFX = builder.define("enableDeathFX", true);
    ...
    public static class Gameplay
    {
        ...
        public Gameplay(ModConfigSpec.Builder builder)
        {
            builder.comment("Properties relating to gameplay").push("gameplay");
            {
                ...
                this.ignoreLeaves = builder.comment("If true, ammoData will ignore leaves when checking for collision").define("ignoreLeaves", true);
                this.enableKnockback = builder.comment("If true, ammoData will cause knockback when an entity is hit. By default this is set to true to match the behaviour of Minecraft.").define("enableKnockback", true);
    ...
    public static class Network
    {
        ...
        public Network(ModConfigSpec.Builder builder)
        {
            ...
            {
                this.projectileTrackingRange = builder.comment("The distance players need to be within to be able to track new ammoData trails. Higher values means you can see ammoData from that start from further away.").defineInRange("projectileTrackingRange", 200.0, 1, Double.MAX_VALUE);
            }
            builder.pop();
        }
    }
